...
function createData(
  ...
  return { number, namamodul, link, statuskerja,aktif,aksi };
}

const rows = [
  createData('1','Dashboard', '?module=dashboard','user', 'Y' , 'edit'),
  createData('2','Pencarian Topik Lain', '?module=topik','user',  'Y' , 'edit'),
  createData('3','Management User', '?module=user','Administrator', 'Y' , 'edit'),
  createData('4','Management User', '?module=module','Administrator', 'Y' , 'edit')
];
      ...
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">Nama Modul</TableCell>
            <TableCell align="right">Link</TableCell>
            <TableCell align="right">Status</TableCell>
            <TableCell align="right">Aktif</TableCell>
            <TableCell align="right">Akis</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="right">{row.namamodul}</TableCell>
              <TableCell align="right">{row.link}</TableCell>
              <TableCell align="right">{row.statuskerja}</TableCell>
              <TableCell align="right">{row.aktif}</TableCell>
